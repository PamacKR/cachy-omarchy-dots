...
#
# Does: base-devel + git -> build yay from the AUR -> run DMS's own installer
# (interactive - you make your own choices there, and it installs Niri
# itself) -> hand off to install.sh for everything else.
set -euo pipefail
...
log "Running DMS's installer (interactive - make your own choices here; it installs Niri itself)..."
