...
# Vendored as-is from https://github.com/heyoeyo/niri_tweaks
# (no license file in the upstream repo at the time of vendoring).
# Run with -n 2 here: first window maximizes, second triggers a 50/50 split,
# beyond that niri's own scrolling/column-width behavior takes over.
